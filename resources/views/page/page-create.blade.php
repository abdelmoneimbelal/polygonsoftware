...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="{{url('admin/custom-page')  . '?language=' . request()->input('language')}}" class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_pages') , array('Attr.EnableID' => true))}}</a>
                    </div>
