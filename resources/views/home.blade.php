                                    ...
                                    @if ($slido->button_text2)
                                        <div class="button-slider-b button-slider-b2">
                                            <a href="{!! $slido->button_link2 !!}" target="_self"
                                                class="btn btn-slider"><span>{!! $slido->button_text2 !!}</span><svg
                                                    width="11.4" height="9.2">
                                                    <use xlink:href="#arrow"></use>
                                                </svg></a>
                                        </div>
                                ...
                                <div class="slider-image">
                                    <div class="slider-image-inner">
                                        <img class="owl-lazy img-fluid slider-img"
                                            data-src="{{ asset('/images/media/' . $slido->photo->file) }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                            ...
                            <div class="item-about-img2">
                                <div class="avo-image avo-tooltip about-img3 big-paral">
                                    <div class="simpleParallax imago"
                                        data-tooltip-tit="{{ $homesetting->about_image3_titlu1 }}"
                                        data-tooltip-sub="{{ $homesetting->about_image3_titlu2 }}"><img
                                            src="/public/img/loading-blog.gif" width="500" height="666"
                                            class="lazy thumparallax-down img-fluid"
                                            data-src="{{ $homesetting->about_image3 }}" alt="about-us" /></div>
                                </div>
                            </div>
                            <div class="item-about-img1">
                                <div class="avo-image avo-tooltip about-img1 big-paral">
                                    <div class="simpleParallax imago"
                                        data-tooltip-tit="{{ $homesetting->about_image2_titlu1 }}"
                                        data-tooltip-sub="{{ $homesetting->about_image2_titlu2 }}"><img
                                            src="/public/img/loading-blog.gif" width="500" height="666"
                                            class="lazy thumparallax-down img-fluid"
                                            data-src="{{ $homesetting->about_image2 }}" alt="about-us" /></div>
                                </div>
                                <div class="avo-image avo-tooltip about-img2 big-paral">
                                    <div class="simpleParallax imago"
                                        data-tooltip-tit="{{ $homesetting->about_image1_titlu1 }}"
                                        data-tooltip-sub="{{ $homesetting->about_image1_titlu2 }}"><img
                                            src="/public/img/loading-blog.gif" width="500" height="666"
                                            class="lazy thumparallax-down img-fluid"
                                            data-src="{{ $homesetting->about_image1 }}" alt="about-us" /></div>
                                </div>
                            </div>
                        </div>
                        <div class="exp-about">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ $homesetting->about_buttonlink }}" target="_self"
                        class="btn btn-style1"><span>{{ $homesetting->about_buttontext }}</span><svg width="11.4"
                            height="9.2">
                            <use xlink:href="#arrow"></use>
                        </svg></a>
                            ...
                            <div class="card featured to-top-left">
                                ...
                                <div class="card-img">
                                    <img class="img-fluid project-image lazy" width="100" height="100"
                                        ...
                                        data-src="{{ asset('/images/media/' . $service->photo->file) }}"
                                        alt="{{ $service->title }}">
                                </div>
                        ...
                        <div class="project-box-div">
                            ...
                            <a href="{{ URL::to('/') }}/project/{{ $project->slug }}" title="{{ $project->title }}">
                                <img class="img-fluid project-image lazy" width="100%" height="400"
                                    style="height: 300px" src="{{ asset('/img/loading-blog.gif ') }}"
                                    data-src="{{ asset('/images/media/' . $project->photo->file) }}"
                                    alt="{{ $project->title }}">
                            </a>
                                ...
                                <div class="project-meta-title">
                                    <a href="{{ URL::to('/') }}/project/{{ $project->slug }}"
                                        title="{{ $project->title }}"><span
                                            class="project__text">{{ $project->title }}</span></a>
                                </div>
                    ...
                    <div class="testimonial-layout1">
                        <div class="item-figure">
                            <img class="img-fluid" width="90" height="90"
                                src="{{ $testimonial->profile_pic ? $testimonial->profile_pic : '/public/img/200x200.png' }}"
                                alt="">
                        </div>
...
{{--                               <img class="lazy blog_post_image img-fluid" width="370" height="380" src="https://cdn.dribbble.com/users/105033/screenshots/1132714/loading-animation-800.gif" data-src="{{ asset('/images/media/' . $post->photo->file) }}" alt="{{$post->title}}"> --}}
{{--                           </a> --}}
