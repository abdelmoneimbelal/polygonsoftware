...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#0">
            ...
            <div class="sidebar-brand-text mx-3">innoworx<sup></sup></div>
        </a>
...
{{--                           href="{{ route('page.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_pages') , array('Attr.EnableID' => true))}}</a>--}}
{{--                        <a class="collapse-item"--}}
{{--                           href="{{ route('page.create') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.create_page') , array('Attr.EnableID' => true))}}</a>--}}

                        <h6 class="collapse-header">{{clean( trans('niva-backend.custom_pages') , array('Attr.EnableID' => true))}}</h6>


                        <a class="collapse-item"
                           href="{{ route('index-custom') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.custom_templates') , array('Attr.EnableID' => true))}}</a>
        ...
        @if(Auth::user()->role->name == 'administrator')
            <li class="nav-item">
                ...
                <div id="collapseProjects" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                           href="{{ route('project.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_projects') , array('Attr.EnableID' => true))}}</a>
                        <a class="collapse-item"
                           href="{{ route('project.create') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.create_project') , array('Attr.EnableID' => true))}}</a>
                        <h6 class="collapse-header">{{clean( trans('niva-backend.categories') , array('Attr.EnableID' => true))}}</h6>
                        <a class="collapse-item"
                           href="{{ route('project-category.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_categories') , array('Attr.EnableID' => true))}}</a>
                    </div>
                </div>
            </li>
        @endif
...
{{--                <div class="bg-white py-2 collapse-inner rounded">--}}
{{--                    <a class="collapse-item"--}}
{{--                       href="{{ route('post.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_posts') , array('Attr.EnableID' => true))}}</a>--}}
{{--                    <a class="collapse-item"--}}
{{--                       href="{{ route('post.create') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.create_post') , array('Attr.EnableID' => true))}}</a>--}}
{{--                    <h6 class="collapse-header">{{clean( trans('niva-backend.categories') , array('Attr.EnableID' => true))}}</h6>--}}
{{--                    <a class="collapse-item"--}}
{{--                       href="{{ route('category.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.all_categories') , array('Attr.EnableID' => true))}}</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </li>--}}
        ...
        <li class="nav-item">
            ...
            <div id="collapseMedia" class="collapse" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item"
                       href="{{ route('media.index') }}">{{clean( trans('niva-backend.all_media') , array('Attr.EnableID' => true))}}</a>
                    <a class="collapse-item"
                       href="{{ route('media.create') }}">{{clean( trans('niva-backend.upload_image') , array('Attr.EnableID' => true))}}</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                           href="{{ route('users.index') }}">{{clean( trans('niva-backend.all_users') , array('Attr.EnableID' => true))}}</a>
{{--                        <a class="collapse-item"--}}
{{--                           href="{{ route('users.create') }}">{{clean( trans('niva-backend.create_user') , array('Attr.EnableID' => true))}}</a>--}}
                    </div>
                </div>
            </li>
    @endif
        ...
        <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseElements" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                           href="{{ route('slider.index') }}?language=@php echo $lang->code; @endphp">Manage slider </a>
                        <a class="collapse-item"
                        ...
                        <a class="collapse-item"
                           href="{{ route('testimonial.index') }}?language=@php echo $lang->code; @endphp">Manage
                            testimonials</a>
                        <a class="collapse-item"
                           href="{{ route('member.index') }}?language=@php echo $lang->code; @endphp">Manage members</a>
                        <a class="collapse-item"
                           href="{{ route('client.index') }}?language=@php echo $lang->code; @endphp">Manage clients</a>
{{--                        <a class="collapse-item"--}}
        ...
        <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseSEO" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                           href="{{ route('setting.edit') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.title_log_favicon') , array('Attr.EnableID' => true))}}</a>
                        <a class="collapse-item"
                           href="{{ route('menu.index') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.main_menu') , array('Attr.EnableID' => true))}}</a>
                        <a class="collapse-item"
                           href="{{ route('headerfooter-setting.edit') }}?language=@php echo $lang->code; @endphp">{{clean( trans('niva-backend.header_and_footer') , array('Attr.EnableID' => true))}}</a>
{{--                        <a class="collapse-item"--}}
{{--                           href="{{ route('language.index') }}">{{clean( trans('niva-backend.all_languages') , array('Attr.EnableID' => true))}}</a>--}}
                    </div>
                </div>
            </li>
    @endif
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li><a target="_blank" href="{{ route('home') }}"
                           class="view-website-link d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                    class="fab fa-chrome"></i> {{clean( trans('niva-backend.view_website') , array('Attr.EnableID' => true))}}
                        </a></li>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="{{ asset('/images/media/' . $user->photo->file) }}" alt="">
                        </a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="exampleModalLabel">{{clean( trans('niva-backend.ready_leave') , array('Attr.EnableID' => true))}}</h5>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button"
                        data-dismiss="modal">{{clean( trans('niva-backend.cancel') , array('Attr.EnableID' => true))}}</button>
                <a class="btn btn-primary" href="{{ route('logout') }}"
                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{clean( trans('niva-backend.logout') , array('Attr.EnableID' => true))}}</a>
