                ...
                @foreach($members as $member)
                  <div class="col-md-4">
                      <div class="venor-team">
                          <div class="thumbnail"> 
                              <img width="350" height="350" class="lazy img-fluid" src="/public/img/loading-blog.gif" data-src="{{$member->photo ? '/images/media/' . $member->photo->file : '/img/200x200.png'}}" alt="team-venor">
                          </div>
                          <div class="content">
