...
class CreateHomeSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('home_settings', function (Blueprint $table) {
            ...
            $table->string('about_image3');
            $table->string('about_image1_titlu1');
            $table->string('about_image1_titlu2');
            $table->string('about_image2_titlu1');
            $table->string('about_image2_titlu2');
            $table->string('about_image3_titlu1');
            $table->string('about_image3_titlu2');
